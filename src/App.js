    ...
    return (
        <div className={`min-h-screen ${darkMode ? 'bg-primary-dark-blue text-white' : 'bg-light-background text-dark-text'} font-inter transition-colors duration-300`}>
            ...
            <style>{`
                ...
                /* New Color Palette */
                .bg-primary-dark-blue { background-color: #002856; }
                .text-primary-dark-blue { color: #002856; }
                .bg-accent-red { background-color: #b41f1f; }
                .text-accent-red { color: #b41f1f; }
                .bg-light-background { background-color: #f2f2f2; }
                .text-light-background { color: #f2f2f2; }
                .bg-white-card, .bg-white { background-color: #ffffff; }
                .text-white-card { color: #ffffff; }
                .bg-secondary-grey { background-color: #d9d9d9; }
                .text-secondary-grey { color: #6c757d; } /* Darker grey for text contrast */
                .text-gold-accent { color: #c9a335; }
                .text-dark-text { color: #343a40; } /* General dark text on light background */

                /* Dark Mode Colors */
                .dark-mode {
                    --bg-dark-background: #1a1a2e; /* Deeper dark blue/purple */
                    --bg-dark-card: #2a2a4a;
                    --text-dark: #e0e0e0;
                ...
                .dark-mode .bg-primary-dark-blue { background-color: #001a33; } /* Darker navy for dark mode header */
                ...
                .dark-mode .input-field {
                    ...
                    color: var(--text-dark); /* Explicit text color for dark mode */
                }
                .dark-mode .input-field::placeholder {
                    color: var(--placeholder-dark);
                }
                .dark-mode .file\\:bg-primary-blue { background-color: #b41f1f; } /* Adjust file input button for dark mode */
                ...
                .input-field {
                    ...
                    color: #343a40; /* Default text color for light mode */
                }
                .input-field option {
                    color: black; /* Ensure options are visible in select */
                ...
                .input-field::placeholder {
                    color: #6c757d; /* Default placeholder color for light mode */
                }
                .dark-mode .input-field::placeholder {
                    color: var(--placeholder-dark);
                }
                ...
                .side-nav {
                    ...
                    height: 100%;
                    width: 250px;
                    background-color: #002856; /* Primary dark blue */
